 ...
 *
 * Koordinaatiston origo on piirtoalueen keskella, x-akselin
 * positiivinen suunta on oikealle, y-akselin ylaspain ja z-akselin
 * katsojasta poispain.
 */
public class Kappale {
	...
	public void kaannaXZ(){
		for (int i=0; i<pisteet.length;i++) pisteet[i].kaannaXZ();
	}

	public void kaannaYZ(){
		for (int i=0; i<pisteet.length;i++) pisteet[i].kaannaYZ();
	}

	public void kaannaZX(){
		for (int i=0; i<pisteet.length;i++) pisteet[i].kaannaZX();
	}

	public void kaannaZY(){
		for (int i=0; i<pisteet.length;i++) pisteet[i].kaannaZY();
	}
